...
<%@include file="../common/header.jsp" %>
                ...
                <div class="container">
                    <table class="table " style="margin: auto; text-align: center;">
                        ...
                        <!--
                            <th>
                                <h5><input type="checkbox" id="select-all" checked>선택</h5>
                            </th>
                            -->
                            <td>
                                <h5>상품 이미지</h5>
                        ...
                        <c:forEach items="${list}" var="item">
                            ...
                            <!--
                                <td style="width: 180px; text-align: center; vertical-align: middle; ">
                                    <input class="checkbox" type="checkbox" id="select-all2" >
                                </td>
                                -->
                                <td style="width: 300px; height: 300px; ">
                                   <a href="/shop/get?p_id=${item.p_id}" > <div class="result-${item.b_id}" style="width: 100%; height: 100%;"></div></a>
                                </td>
                                <td style="width: 180px; text-align: center; vertical-align: middle; ">
                                ...
                                <td style="width: 200px; text-align: center; vertical-align: middle; ">
                                    <h5 class="fw-bold mb-3" style="text-decoration: line-through;">
                                        정가 :
                                        <fmt:formatNumber value="${item.p_price * item.quantity}" pattern="#,###" />원
                                    </h5>
                                    <h5 class="fw-bold mb-3">
                                        할인율 :
                                        <fmt:formatNumber value="${item.p_discount}" pattern="#,###" /> %
                                    </h5>
                                    <c:set var="discountedPrice"
                                        value="${item.p_price - (item.p_price * (item.p_discount / 100.0))}" />
                                    <h5 class="fw-bold mb-3">
                                        판매가 :
                                        <fmt:formatNumber value="${discountedPrice * item.quantity}" type="number"
                                            maxFractionDigits="0" />원
                                    </h5>
                                </td>
                                <td style="width: 150px; text-align: center; vertical-align: middle; ">
                                    <button type="button" class="btn btn-danger d_btn"
                                        data-b_id='<c:out value="${item.b_id}"/>'><i class="bi bi-trash"></i></button>
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
                    ...
                    <div>
                        <button type="button" class="btn btn-info buyBtn" style="float:right; margin-top:10px;"> 구매하기
                        </button>
                    </div>
                </div>
