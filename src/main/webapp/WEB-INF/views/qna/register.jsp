    ...
    <div class="container mt-5">
        ...
        <div class="card mt-5">
            ...
            <div class="card-body" id="product_register_card">
               ...
               <form role="form" method="post" action="/qna/register" id="formObj" >

                     <div class="form-group" style="margin-bottom:20px;">
                           <label for="product_name"><span class="badge bg-primary">제목</span></label>
                           <input type="text" class="form-control" name="q_title" placeholder="글 제목을 입력하세요."/>
                       </div>

                        <div class="form-group" style="margin-bottom:20px;">
                           <label for="product_name"><span class="badge bg-primary">작성자</span></label>
                           <input type="text" class="form-control" name="q_writer" value="${member.member_id}" readonly = "readonly"/>
                       </div>
                    ...
                    <div class="form-group" style="margin-bottom:20px;">
                       ...
                       <textarea id="editor" name="q_content"></textarea>
                    </div>
<!--
                <div class="form-group" style="margin-bottom:20px;">
   ...
   -->
                <div>
                        <button type="submit" class="btn btn-primary" id="register_btn">작성</button>
